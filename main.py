...
FONT = pygame.font.Font('Font.ttf', int(HEIGHT / 40))
...
class Button(pygame.sprite.Sprite):
    def __init__(self, position, text, size):
        ...
        self.rect = self.image.get_rect()
        self.rect.center = position
        self.font = pygame.font.Font('Font.ttf', int(HEIGHT / 20))
...
class Game:
    ...
    def render_main(self):
        ...
        text_upgr_1 = self.font.render("Points per Click", True, FONT_COLOR)
        text_upgr_2 = self.font.render("Points per Tick", True, FONT_COLOR)
        SCREEN.blit(text1, (5 * WIDTH / 8, 11 * HEIGHT / 12))
        SCREEN.blit(text_upgr_1, (WIDTH / 4, HEIGHT / 20))
        SCREEN.blit(text_upgr_2, (3 * WIDTH / 4, HEIGHT / 20))
        pygame.display.flip()
    ...
    def change_screen_size(self):
        ...
        self.menu_buttons = MAIN_MENU
        self.logo = Logo((WIDTH / 10, 23 * HEIGHT / 24))
        self.font = pygame.font.Font('Font.ttf', int(WIDTH / 40))
        self.font2 = pygame.font.Font('Font.ttf', int(WIDTH / 20))
